    ...
    <header className="absolute w-full z-50 transition-all duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="lg:flex hidden space-x-8">
          {["Home", "About", "Projects", "Experience", "Skills", "Certifications", "Resume", "Contact"].map((item, index) => (
            <motion.a
              key={item}
      ...
      <motion.div
        ...
        <nav className="flex flex-col space-y-3">
          {["Home", "About", "Projects", "Experience", "Skills", "Certifications", "Resume", "Contact"].map((item) =>
          (
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="mt-6 block w-full px-4 py-3 rounded-xl bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 text-white font-bold tracking-wide shadow-lg shadow-violet-900/30 transition-all duration-300">
      ...
      <AnimatePresence>
        {contactFormOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4"    //AI 
          >
            <motion.div
            ...
            >
              ...
              <form className="space-y-4">
                ...
                <div>
                  <lable htmlFor="emai" className="block text-sm font-medium text-gray-300 mb-1">
                    Email
                  </lable>
                  <input
                    type="email"

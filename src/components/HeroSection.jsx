    ...
    <section className="h-screen bg-gradient-to-b from-violet-900 to-black flex xl:flex-row flex-col-reverse items-center justify-between lg:px-24 px-10 relative overflow-hidden">
        ...
        <div className="z-40 xl:mb-0 mb-[20%]">
            ...
            className="text-xl md:text-1xl lg:text-2xl text-purple-200 max-w-2xl">
                Software engineering isn't just about syntax; it's a journey of relentless consistency and resilient patience. I am a final-year developer using Java DSA to unravel complex problems and the MERN stack to deploy interactive digital experiences, continuously mastering my craft while stepping into the future of AI
            </motion.p>
        </div>

...
const ContactSection = () => {
    ...
    useEffect(() => {
        ...
        // Make sure all scrollTroigger instance are properly killed
        const cleanup = () => {
        ...
        >
            ...
            >
                ...
                <h1 className="text-black md:w-[10rem] w-[20rem] lg:scale-[0.4] sm:scale-[0.25] scale-[0.07] md:font-bold text-sm sm:text-base leading-none mb-5">
                    Step Into the Future with Ishan
                    {/* Let's build something meaningful, not just write code */}
                </h1>

                <p className="text-black lg:w-[40rem] w-[20rem] absolute sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068]">
                    I am a final-year software engineering student currently focused on implementing core data structures and algorithmic logic in Java,
                     {/* alongside making strong concepts in key computer science fundamentals including DBMS, Computer Networks, Operating Systems, and Compiler Design etc. Moving forward, my technical journey involves exploring the fields of AI/ML, while actively developing hands-on full-stack web applications using the MERN stack with a good habit of a clean, simple coding journey */}
                </p>
